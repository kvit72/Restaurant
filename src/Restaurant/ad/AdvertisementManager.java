...
public class AdvertisementManager {
    ...
    public void processVideos() {
        ...
        obtainOptionalVideoSet(new ArrayList<>(), timeSeconds, 0L);
    ...
    private void obtainOptionalVideoSet(List<Advertisement> totalList, int currentTimeSecondsLeft, long currentAmount) {
        ...
        for (Advertisement ad : tmp) {
            ...
            currentList.add(ad);
            obtainOptionalVideoSet(currentList, currentTimeSecondsLeft - ad.getDuration(), currentAmount + ad.getAmountPerOneDisplaying());
        }
    }
